...
public class LoggingAspectAfter {
	 ...
	 */
	/*
	 * @AfterReturning("args(var_name)") public void
	 * stringArgumentMethods(String var_name) {
	 * 
	 * System.out.println("This from the After Class and variable is now : " +
	 * var_name);
	 * 
	 * }
	 */
	 ...
	 */
	/*
	 * @AfterThrowing("args(var_name)") public void exceptionAdvice(String
	 * var_name) {
	 ...
	 * System.out.println("This from the After Class and variable is now : " +
	 * var_name);
	 * System.out.println("This from the After Class and RETURN VALUE is : " +
	 * returnValue);
	 * 
	 * }
	 */
	 ...
	 */
	/*
	 * @AfterThrowing(pointcut = "args(var_name)", throwing = "ex") public void
	 * getExceptionThrown(String var_name, RuntimeException ex) { System.out.
	 * println("This is the exeption thrown in the triggering class : " +
	 * ex.getStackTrace()); }
	 */
